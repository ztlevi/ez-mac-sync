...
if __name__ == "__main__":
    ...
    initial_ignore_lists = {"cloudDir": "", "brewIgnoreList": [
    ], "brewCaskIgnoreList": [], "masIgnoreList": []}
    ...
    brew_ignore_set = set(
        map(lambda app: app.lower(), ignore_lists['brewIgnoreList']))
    ...
    brew_cask_ignore_set = set(
        map(lambda app: app.lower(), ignore_lists['brewCaskIgnoreList']))
    ...
    mas_ignore_set = set(
        map(lambda app: app.lower(), ignore_lists['masIgnoreList']))
